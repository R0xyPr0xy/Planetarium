...
async function fetchDistanceToEarth() {
  ...
  let distance =
    data.entities.Q308.claims.P2583[0].mainsnak.datavalue.value.amount;
...
async function fetchTemperature() {
  ...
  let temperature =
    data.entities.Q308.claims.P2076[0].mainsnak.datavalue.value.amount;
...
async function fetchRadius() {
  ...
  // Extracting radius
  let radius =
    data.entities.Q308.claims.P2120[0].mainsnak.datavalue.value.amount;
